...
function Home() {
  ...
  const fetchTeachersByClassesRange = async (classesRange) => {
    try {
      const response = await axios.get(
        `http://localhost:4000/teachers/filterByClasses?classes=${classesRange}`
      );
  ...
  const fetchTeachersByAgeRange = async (ageRange) => {
    try {
      const response = await axios.get(
        `http://localhost:4000/teachers/filterByAge?age=${ageRange}`
      );
      setTeachers(response.data);
    } catch (error) {
      console.error("Error fetching teachers:", error);
  ...
  const handleEdit = async (teacherToEdit) => {
    try {
      const response = await fetch(
        `http://localhost:4000/editteacher/${teacherToEdit.id}`,
        {
          method: "PUT",
          headers: {
  ...
  const handleDelete = async (teacherToDelete) => {
    try {
      const response = await fetch(
        `http://localhost:4000/deleteteacher/${teacherToDelete.id}`,
        {
          method: "DELETE",
        }
      );
  ...
  const fetchTeachersBySearchQuery = async (query) => {
    try {
      const response = await axios.get(
        `http://localhost:4000/teachers/search/${query}`
      );
      setTeachers(response.data);
    } catch (error) {
      console.error("Error fetching teachers:", error);
